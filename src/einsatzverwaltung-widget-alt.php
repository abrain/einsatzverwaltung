 ...
 */
class WidgetAlternateLetzteEinsaetze extends WP_Widget
{
    ...
    {
        parent::__construct(
            'einsatzverwaltung_alt_widget', // Base ID
            'Letzte Eins&auml;tze (Alternativ)', // Name
    ...
    public function widget($args, $instance)
    {
        ...
        while ($query->have_posts()) {
			...
			if ($zeigeDatum) {
                ...
                $letzteEinsaetze .= "<span class=\"einsatzdatum\">".date_i18n($datumsformat, $timestamp)."</span>";
                if ($zeigeZeit) {
...
add_action('widgets_init', function() {
    register_widget('abrain\Einsatzverwaltung\WidgetAlternateLetzteEinsaetze');
});
